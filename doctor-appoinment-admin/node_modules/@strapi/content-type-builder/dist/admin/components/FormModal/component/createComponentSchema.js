...
var regex = require('../category/regex.js');
...
const createComponentSchema = (usedComponentNames, reservedNames, category, takenCollectionNames, currentCollectionName)=>{
    const shape = {
        ...
        category: yup__namespace.string().matches(regex.CATEGORY_NAME_REGEX, strapiAdmin.translatedErrors.regex.id).required(strapiAdmin.translatedErrors.required.id),
